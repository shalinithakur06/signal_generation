...
# with command line options: --filein file:RAWSIM.root --fileout AODSIM.root --mc --eventcontent AODSIM --era Run2_25ns --datatier AODSIM --conditions auto:run2_mc --step RAW2DIGI,L1Reco,RECO,EI --magField 38T_PostLS1 --geometry DBExtendedPostLS1 --python_filename step4.py --no_exec -n 10
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/user/sdutt/LHEGeneration_Ele/LHEGen_DIGIHLTEleM2000/180207_015353/0000/RAWSIM_16.root'),
