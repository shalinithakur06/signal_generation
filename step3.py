...
# with command line options: --filein file:step2.root --fileout RAWSIM.root --mc --eventcontent RAWSIM --pileup AVE_20_BX_25ns --era Run2_25ns --datatier GEN-SIM-RAW --conditions auto:run2_mc --step DIGI,L1,DIGI2RAW,HLT,RAW2DIGI,L1Reco --magField 38T_PostLS1 --geometry DBExtendedPostLS1 --python_filename step3.py --no_exec -n 10
...
process.source = cms.Source("PoolSource",
    ...
    #'file:step2.root',
   '/store/user/sdutt/LHEGeneration_Ele/GENSIM_ExictedElec10k_M4000_100Evts/180204_150627/0000/step2_11.root', 
    ),
